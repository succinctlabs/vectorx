    ...
    fn test_permuation() -> Result<(), anyhow::Error> {
        ...
        let test_vectors: Vec<([Fr; 4], [Fr; 4])> = vec![
            (
                [Fr::zero(); 4],
                [
                    Fr::from_str("5317387130258456662214331362918410991734007599705406860481038345552731150762").unwrap(),
                    Fr::from_str("17768273200467269691696191901389126520069745877826494955630904743826040320364").unwrap(),
                    Fr::from_str("19413739268543925182080121099097652227979760828059217876810647045303340666757").unwrap(),
                    Fr::from_str("3717738800218482999400886888123026296874264026760636028937972004600663725187").unwrap(),
                ]
            ),
            (
                [
                ...
                [
                    Fr::from_str("6542985608222806190361240322586112750744169038454362455181422643027100751666").unwrap(),
                    Fr::from_str("3478427836468552423396868478117894008061261013954248157992395910462939736589").unwrap(),
                    Fr::from_str("1904980799580062506738911865015687096398867595589699208837816975692422464009").unwrap(),
                    Fr::from_str("11971464497515232077059236682405357499403220967704831154657374522418385384151").unwrap(),
                ]
            ),
            (
                [max_value; 4],
                [
                    Fr::from_str("13055670547682322550638362580666986963569035646873545133474324633020685301274").unwrap(),
                    Fr::from_str("19087936485076376314486368416882351797015004625427655501762827988254486144933").unwrap(),
                    Fr::from_str("10391468779200270580383536396630001155994223659670674913170907401637624483385").unwrap(),
                    Fr::from_str("17202557688472898583549180366140168198092766974201433936205272956998081177816").unwrap(),
                ]
            ),
            (
                [
                ...
                [
                    Fr::from_str("21792249080447013894140672594027696524030291802493510986509431008224624594361").unwrap(),
                    Fr::from_str("3536096706123550619294332177231935214243656967137545251021848527424156573335").unwrap(),
                    Fr::from_str("14869351042206255711434675256184369368509719143073814271302931417334356905217").unwrap(),
                    Fr::from_str("5027523131326906886284185656868809493297314443444919363729302983434650240523").unwrap(),
                ]
            ),
        ];
